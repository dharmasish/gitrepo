...
//1
unsigned long samplingTime = 10;  // time in us to collect all the numberOfSamples
int samplingPause = 2; //3 time in ms to pause between continuous sampling
